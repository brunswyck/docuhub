...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_gallery_plot_sin_demo.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_plot_sin_demo.py:
...
.. image:: /gallery/images/sphx_glr_plot_sin_demo_001.png
    :alt: plot sin demo
...
.. _sphx_glr_download_gallery_plot_sin_demo.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: plot_sin_demo.py <plot_sin_demo.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: plot_sin_demo.ipynb <plot_sin_demo.ipynb>`
